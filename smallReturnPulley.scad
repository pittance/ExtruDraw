...
difference() {
    rotate([0,0,0])union() {
        ...
        // layer for support of overhang
        translate([0,0,4])cylinder(h=0.2,d=12);
    }
    cylinder(h=4,d=10.5,$fn=30);
    translate([0,0,15.5-4+1])cylinder(h=4,d=10.5,$fn=30);
    translate([0,0,15.5-5+1])cylinder(h=1,d=7,$fn=30);
}
// Functions
...
//        polygon([[0,0],[pulley_OD/2,0],[pulley_OD/2 + retainer_ht , retainer_ht],[pulley_OD/2 + retainer_ht , retainer_ht*2],[0 , retainer_ht*2],[0,0]]);}
		...
		translate([0,0,-1])cylinder(r2=motor_shaft/2,r1=7/2,h=pulley_b_ht + pulley_t_ht + retainer_ht + 1,$fn=motor_shaft*4);
...
module belts() {
    ...
    color([0.3,0.3,0.3])
    translate([-beltSpce/2,-beltSpce/2,-14]) {
        translate([-60+beltSpce/2,0,0])cube([120,beltThic,beltWide]);
        translate([-60+beltSpce/2,beltSpce-beltThic,0])cube([120,beltThic,beltWide]);
        translate([beltThic,-60+beltSpce/2,0])rotate([0,0,90])cube([120,beltThic,beltWide]);
        translate([beltSpce,-60+beltSpce/2,0])rotate([0,0,90])cube([120,beltThic,beltWide]);
    }
}
//