...
motor_shaft = 5.6;	// NEMA17 motor shaft exact diameter = 5
...
//        //       ctr    lower edge      top edge                                  ctr top           ctr
		...
		translate([0,0,-1])cylinder(r=motor_shaft/2,h=pulley_b_ht + pulley_t_ht + retainer_ht*2 + 2,$fn=motor_shaft*4);
